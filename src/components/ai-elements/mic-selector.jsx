...
export const MicSelectorTrigger = ({
  ...
  return (<PopoverTrigger render={<Button variant="outline" {...props} ref={ref} />}>{children}<ChevronsUpDownIcon className="shrink-0 text-muted-foreground" size={16} /></PopoverTrigger>);
};
