  ...
  return (
    <DropdownMenuItem
      ...
      render={<a
        ...
        rel="noopener"
        target="_blank" />}><span className="shrink-0">{providers.chatgpt.icon}</span><span className="flex-1">{providers.chatgpt.title}</span><ExternalLinkIcon className="size-4 shrink-0" /></DropdownMenuItem>
  );
};
  ...
  return (
    <DropdownMenuItem
      ...
      render={<a
        ...
        rel="noopener"
        target="_blank" />}><span className="shrink-0">{providers.claude.icon}</span><span className="flex-1">{providers.claude.title}</span><ExternalLinkIcon className="size-4 shrink-0" /></DropdownMenuItem>
  );
};
  ...
  return (
    <DropdownMenuItem
      ...
      render={<a
        ...
        rel="noopener"
        target="_blank" />}><span className="shrink-0">{providers.t3.icon}</span><span className="flex-1">{providers.t3.title}</span><ExternalLinkIcon className="size-4 shrink-0" /></DropdownMenuItem>
  );
};
  ...
  return (
    <DropdownMenuItem
      ...
      render={<a
        ...
        rel="noopener"
        target="_blank" />}><span className="shrink-0">{providers.scira.icon}</span><span className="flex-1">{providers.scira.title}</span><ExternalLinkIcon className="size-4 shrink-0" /></DropdownMenuItem>
  );
};
  ...
  return (
    <DropdownMenuItem
      ...
      render={<a
        ...
        rel="noopener"
        target="_blank" />}><span className="shrink-0">{providers.v0.icon}</span><span className="flex-1">{providers.v0.title}</span><ExternalLinkIcon className="size-4 shrink-0" /></DropdownMenuItem>
  );
};
  ...
  return (
    <DropdownMenuItem
      ...
      render={<a
        ...
        rel="noopener"
        target="_blank" />}><span className="shrink-0">{providers.cursor.icon}</span><span className="flex-1">{providers.cursor.title}</span><ExternalLinkIcon className="size-4 shrink-0" /></DropdownMenuItem>
  );
};
